 ...
 * para posibles comportamientos implementables de un ebook
 */
public class Ebook extends Libro {
     ...
     */
    protected Ebook(int id, String titulo, String autor, int anio, String genero, boolean disponible, String formato){
