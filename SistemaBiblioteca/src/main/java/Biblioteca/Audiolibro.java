 ...
 * para posibles comportamientos implementables de un audiolibro
 */
public class Audiolibro extends Libro{
     ...
     */
    protected Audiolibro(int id, String titulo, String autor, int anio, String genero, boolean disponible, String formato){
